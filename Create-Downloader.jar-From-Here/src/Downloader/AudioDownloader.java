...
public class AudioDownloader extends Downloader{
	...
	public AudioDownloader(JButton btnStart, JTextArea txtrAudioprogresstext,
		...
		storageFolder=System.getProperty("user.dir")+"/QuranAudio";
		itemId="Audio";
		maxVal=6236;
	...
	class Runner implements Runnable
	{
		...
		public void run() 
		{
			for(int i=start;i<=totalAyas[suraNo-1];i+=gap)
			{
				...
				File outFile = new File(storageFolder+"/" + name);
				...
				setProgress(100*totalAyahRead/maxVal);
			}
		}
	}
