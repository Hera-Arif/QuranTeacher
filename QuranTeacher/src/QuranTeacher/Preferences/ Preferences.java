...
public abstract class Preferences {
	...
	public static final String storageFolder=System.getProperty("user.dir")+"/preferences";
	...
	public Preferences(String id, boolean fontsNotInitialized)
	{
		...
		MyFonts.init();
		MyFonts.addFont("/QuranTeacher/fonts/Tahoma.ttf");
		MyFonts.addFont("/QuranTeacher/fonts/me_quran_volt_mark2.ttf");
		MyFonts.addFont("/QuranTeacher/fonts/SolaimanLipi_22-02-2012.ttf");
		MyFonts.refresh();
	}
